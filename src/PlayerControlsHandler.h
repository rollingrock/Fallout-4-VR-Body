...
namespace frik
{
    ...
    private:
        ...
        REX::EnumSet<RE::UserEvents::USER_EVENT_FLAG, std::uint32_t> _lastForceEnableInputUserEventsFlags;
    };
    ...
    inline void PlayerControlsHandler::enableControls()
    {
        ...
        RE::BSInputEnableManager::GetSingleton()->forceEnableInputUserEventsFlags = _lastForceEnableInputUserEventsFlags;
    }
    ...
    inline void PlayerControlsHandler::disableControls()
    {
        ...
        _lastForceEnableInputUserEventsFlags = RE::BSInputEnableManager::GetSingleton()->forceEnableInputUserEventsFlags;

        // disable everything except fast travel
        const auto disableFlags = RE::OtherInputEvents::OTHER_EVENT_FLAG::kAll & ~RE::OtherInputEvents::OTHER_EVENT_FLAG::kFastTravel;
        RE::BSInputEnableManager::GetSingleton()->ForceOtherEventEnabledVR(disableFlags, false);
    }
}
