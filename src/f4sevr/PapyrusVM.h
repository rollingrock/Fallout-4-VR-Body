...
namespace F4SEVR
{
    ...
    public:
        ...
        DEFINE_MEMBER_FN(SendPapyrusEvent, void, 0x013F9BC0, UInt64 handle, const BSFixedString& eventName, std::function<bool(void*)> functor); // Signature not correct yet
    };

    inline GameVM* getGameVM()
    {
        static REL::Relocation<GameVM**> g_gameVM(REL::Offset(0x05935428));
        return *g_gameVM.get();
    }
}
